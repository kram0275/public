...
Manual calculation of the $R^2$ values for the Gage models reveals slight improvements in fit. Gage model 1 gives $R^2 = 0.8722$ (vs. 0.8534 for OLS).  Gage model 2 gvies $R^2 = 0.8593$ (vs. 0.8248 for OLS). Plots of *ref* vs. *m1* and *m2*, along with their respective OLS and gage trendlines, are shown in Fig. 3 below.  
