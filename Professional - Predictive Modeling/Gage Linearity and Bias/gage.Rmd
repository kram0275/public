...
Of note are the $R^2$ values for each model: $R^{2}_{m_{1}, ref} = 0.8534$, $R^{2}_{m_{2}, ref} = 0.8248$. These values suggest a strong linear correlation between each portable machine's reading and the reference reading, which is corroborated by the low p-values observed for including *ref* as a linear predictor.  
...
$bias_2 = 1.0542 + 0.46118(ref)$. [Eq. 4]    
...
By substituting Eqs. 3 and 4 into Eqs. 5 and 6, respectively:
